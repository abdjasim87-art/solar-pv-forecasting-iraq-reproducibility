...
SRC=W/"output"/"loco_fewshot"/"H24"/"selection_refit"
ARC=W/"loco_fewshot_A10_H24_audit.tar.gz"
STAGE=W/"_A10_audit_pack"
if STAGE.exists():
    import shutil; shutil.rmtree(STAGE)
STAGE.mkdir(parents=True)
PACK=STAGE/"loco_fewshot_A10_H24_audit"
PACK.mkdir()
...
report={
    ...
    "stage_lock_present":(SRC/"A10_H24_stage_lock.json").is_file(),
