...
W=Path("/workspace/lstm"); ROOT=W/"output"/"loco_fewshot"/"H24"/"test"/"90d"
ARC=W/"loco_fewshot_A50_H24_90d_audit.tar.gz"; TMP=W/"_A50_pack"; PACK=TMP/"loco_fewshot_A50_H24_90d_audit"
...
rep={"stage":"A50","files_total":len(rows),"npz_excluded":sum(not r["copied"] for r in rows),"non_npz_copied":sum(r["copied"] for r in rows),"raw_npz_bytes_excluded_from_archive":True}
