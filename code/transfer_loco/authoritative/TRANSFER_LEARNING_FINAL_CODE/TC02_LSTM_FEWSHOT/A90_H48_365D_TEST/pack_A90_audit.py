...
W=Path("/workspace/lstm"); ROOT=W/"output"/"loco_fewshot"/"H48"/"test"/"365d"
ARC=W/"loco_fewshot_A90_H48_365d_audit.tar.gz"; TMP=W/"_A90_pack"; PACK=TMP/"loco_fewshot_A90_H48_365d_audit"
...
rep={"stage":"A90","files_total":len(rows),"npz_excluded":sum(not r["copied"] for r in rows),"non_npz_copied":sum(r["copied"] for r in rows),"raw_npz_bytes_excluded_from_archive":True}
