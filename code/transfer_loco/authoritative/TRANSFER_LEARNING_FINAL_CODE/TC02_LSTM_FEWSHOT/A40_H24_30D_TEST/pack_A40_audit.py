...
W=Path("/workspace/lstm"); ROOT=W/"output"/"loco_fewshot"/"H24"/"test"/"30d"
ARC=W/"loco_fewshot_A40_H24_30d_audit.tar.gz"; TMP=W/"_A40_pack"; PACK=TMP/"loco_fewshot_A40_H24_30d_audit"
...
rep={"stage":"A40","files_total":len(rows),"npz_excluded":sum(not r["copied"] for r in rows),"non_npz_copied":sum(r["copied"] for r in rows),"raw_npz_bytes_excluded_from_archive":True}
