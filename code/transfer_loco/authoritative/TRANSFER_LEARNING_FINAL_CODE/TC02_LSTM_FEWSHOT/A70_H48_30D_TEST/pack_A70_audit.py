...
W=Path("/workspace/lstm"); ROOT=W/"output"/"loco_fewshot"/"H48"/"test"/"30d"
ARC=W/"loco_fewshot_A70_H48_30d_audit.tar.gz"; TMP=W/"_A70_pack"; PACK=TMP/"loco_fewshot_A70_H48_30d_audit"
...
rep={"stage":"A70","files_total":len(rows),"npz_excluded":sum(not r["copied"] for r in rows),"non_npz_copied":sum(r["copied"] for r in rows),"raw_npz_bytes_excluded_from_archive":True}
