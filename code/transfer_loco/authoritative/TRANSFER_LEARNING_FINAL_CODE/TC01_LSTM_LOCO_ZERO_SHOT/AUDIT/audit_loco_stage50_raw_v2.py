...
def main():
    ...
    ap.add_argument("--test_dir",default="/workspace/lstm/output/loco_transfer_v2/H24/history_aware/test")
    ap.add_argument("--out_dir",default="/workspace/lstm/output/loco_transfer_v2/H24/history_aware/raw_audit_v2")
    a=ap.parse_args()
