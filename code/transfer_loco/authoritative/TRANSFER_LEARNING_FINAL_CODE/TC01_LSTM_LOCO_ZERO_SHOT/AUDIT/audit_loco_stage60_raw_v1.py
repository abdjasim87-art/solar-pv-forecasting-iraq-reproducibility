...
def main():
    ...
    ap.add_argument("--test_dir",default="/workspace/lstm/output/loco_transfer_v2/H24/cold_start/test")
    ap.add_argument("--out_dir",default="/workspace/lstm/output/loco_transfer_v2/H24/cold_start/raw_audit_v1")
    a=ap.parse_args()
